 ...
 <br> <br> <br> <br>
  ...
  <?php if(isset($_GET['status'])): ?>
    ...
    <button type="button" class="close" data-dismiss="alert">&times;</button>
        <?php
            if($_GET['status'] == 'sukses'){
                ...
                echo "Your Page Has Been Published Successfully";
            } else if ($_GET['status'] == 'failed1') {
              echo "Sorry There Is An Error Your Page Can't Be Posted";
    ...
    <?php endif; ?>     
      <div class="row">
        <div class="col-md-12">
        <a href="admin8.php" class="btn btn-primary"><i class="fas fa-plus"></i> Create</a>
        <br><br>
    ...
    <?php
        ...
        <td>
            ...
            <td>
            <img src="upload/<?php echo $row['foto']; ?>" width="330px" height="350px">
            </td>
