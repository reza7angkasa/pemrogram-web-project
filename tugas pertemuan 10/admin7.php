...
<br><br> <br><br>
    ...
    <div class="container">
        <marquee><h2><b>Write A Story For Your Page?</b></h2></marquee>
      
        <br><br>
<div class="container mb-3">

<form action="proseslatihan.php" method="POST" enctype="multipart/form-data">

<div class="form-group">
          <label>Title</label>
						<input type="text" name="title" id="title" class="form-control" placeholder="What's The Title?" required/>
					</div>
					<div class="form-group">
          <label>Synopsis</label>
						<textarea class="form-control" id="synopsis" name="synopsis"  rows="10" placeholder="What's The Synopsis?" required></textarea>
					</div>
					<div class="form-group">
