...
<br>  <br>
    <form action="prosesedit2.php" method="POST"  enctype="multipart/form-data">
            ...
            <label>Title</label>
            <input type="text" name="title" class="form-control" placeholder="Title" value="<?php echo $d['title'] ?>" required>
        </div>
        <div class="form-group">
        <label>Synopsis</label>
        <textarea name="synopsis" rows="10" class="form-control" placeholder="Synopsis" required><?php echo $d['synopsis'] ?></textarea>
        </div>
        <div class="form-group">
        <label>Picture</label><br>
								<img src="upload/<?php echo $d['avatar'] ?>"
