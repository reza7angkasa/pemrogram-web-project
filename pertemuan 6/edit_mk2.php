...
<body>
    ...
    ?>
    <div class="container">
    <marquee><h2>Pengeditan Mata Kuliah versi 2 (dg Modal)</h2></marquee>   
    <!-- Ini Modal -->
...
<div class="container">
    ...
    <form id="myform" method="POST" action="proses_edit.php">
        ...
        <button type="button" id="tombol" class="btn btn-success btn-block">
								<i class="fa fa-save"></i> Save
							</button>
    </input>
    <br>
    <a class="btn btn-danger btn-block" href="listmatakuliah.php"><i class="fas fa-times-circle"></i> Cancel</a>
    <br>
        </fieldset>
